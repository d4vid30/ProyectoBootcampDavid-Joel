...
from generar_graficos import generar_todos_los_graficos, generar_grafico_lineas_capacidad_instalada, generar_grafico_area_consumo_total
...
def generar_graficos():
    try:
        output_path = os.path.join("C:/users/Natalia/OneDrive/Desktop/ProyectofinalBOOT/ProyectoBootcamp/Frontend/public/gifs")
